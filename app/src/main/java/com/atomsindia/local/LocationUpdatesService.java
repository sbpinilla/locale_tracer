...
import com.atomsindia.local.network.ApiUtils;
import com.atomsindia.local.network.PosicionDTO;
...
public class LocationUpdatesService extends Service {
    ...
    private void SavetoServer(){
        ...
        posicionDTO.setLat(String.valueOf(latitude));
        posicionDTO.setLon(String.valueOf(longitude));

        ApiUtils.getAPIService().savePost(posicionDTO).enqueue(new Callback<PosicionDTO>() {
            @Override
            public void onResponse(Call<PosicionDTO> call, Response<PosicionDTO> response) {
            ...
            @Override
            public void onFailure(Call<PosicionDTO> call, Throwable t) {
                Log.d("resMM", "error"+t.getMessage());
            }
        });
